...
import { shopkeeperMenu } from './shopkeeperMenu';
      ...
      <main className="shopkeeper-main">
        <header className="shopkeeper-topbar">
          ...
          <div className="shopkeeper-actions">
            <Link className="shop-action-btn primary" to="/shopkeeper/sales"><i className="bi bi-receipt" /> New Sale</Link>
            <ProfileMenu user={user} onLogout={logout} profilePath="/shopkeeper/profile" />
          </div>
        </header>
